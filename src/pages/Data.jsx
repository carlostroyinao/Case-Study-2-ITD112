...
import EducationLevelTable from "../components/tables/EducationLevelTable";
import OccupationTable from "../components/tables/OccupationTable";
import OriginTable from "../components/tables/OriginTable";
import MajorCountryTable from "../components/tables/MajorCountryTable";
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="top-text header-text">
                <h6>Browse For Categories of Emigrants</h6>
                <h2>
                  Explore the different dimensions of Filipino emigration — from
                  destinations and age groups to reasons for leaving.
                </h2>
              </div>
            </div>
          </div>
